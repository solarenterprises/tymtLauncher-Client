  ...
  return (
    <div>
      ...
      >
        ...
        >
          <Box className={"fs-14-regular light m-b-8"}>
            {t("ncca-33_third-word")}
          </Box>
          <MnemonicInput
            word={threeConfirmStore.first}
            focus={threeConfirmStore.focus === 1 ? true : false}
          />
        </div>
        <div
          style={{
        ...
        >
          <Box className={"fs-14-regular light m-b-8"}>
            {t("ncca-34_sixth-word")}
          </Box>
          <MnemonicInput
            word={threeConfirmStore.second}
            focus={threeConfirmStore.focus === 2 ? true : false}
          />
        </div>
        <div
          style={{ width: "163px", height: "69px" }}
        ...
        >
          <Box className={"fs-14-regular light m-b-8"}>
            {t("ncca-35_ninth-word")}
          </Box>
          <MnemonicInput
            word={threeConfirmStore.third}
            focus={threeConfirmStore.focus === 3 ? true : false}
          />
        </div>
      </div>
    </div>
