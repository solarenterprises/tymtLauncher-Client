...
const GameReview = ({}: IPropsGameReview) => {
    ...
    <>
      <Stack direction={"row"} alignItems={"center"} justifyContent={"space-between"} display={"flex"}>
        <Box className={"fs-40-bold white"}>
          ...
          >
            <Rating name="hover-feedback" value={3} precision={0.5} readOnly getLabelText={getLabelText} IconContainerComponent={StyledStarIcon} />
