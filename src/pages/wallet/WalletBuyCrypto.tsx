        ...
        <Grid item xs={12} container justifyContent={"center"}>
          ...
          >
              ...
              >
                <Stack width={"100%"}>
                  <InputBox
                    ...
                    align="left"
                    value={usd}
                    onChange={(value: string) => setUsd(value)}
                  ></InputBox>
                  <Box className={"fs-12-light light"}>
                    ~${chain.value * chain.count}
                  </Box>
                </Stack>
                <Stack
                  direction={"row"}
              ...
              >
                <Stack width={"100%"}>
                  <InputBox
                    ...
                    align="left"
                    value={sxp}
                    onChange={(value: string) => setSxp(value)}
                  ></InputBox>
            ...
            <Button
              ...
              onClick={() => navigate("/wallet/payment-method")}
            >
              {t("wal-34_approve")}
            </Button>
          </Box>
