                ...
                >
                  <Grid item xs={12} container justifyContent={"space-between"}>
                    ...
                    <Stepper
                      all={4}
                      now={4}
                      texts={["", "", "", t("ncca-39_create-nickname")]}
                    />
                  </Grid>

                  <Grid item xs={12} mt={"80px"}>
                    <AccountHeader
                      title={t("ncca-40_your-nickname")}
                      text={t("ncca-41_nickname-will-displayed")}
                    />
                  </Grid>
                  <form
...
export default NonCustodialImport2;
