...
export const RedEclipse: IGame = {
  ...
  releaseMeta: {
    ...
    platforms: {
      ...
      darwin_amd64: {
        name: "redeclipse_2.0.0_mac.tar.bz2",
        executable: "redeclipse.app",
        installSize: "",
        downloadSize: "",
        external_url: "https://github.com/redeclipse/base/releases/download/v2.0.0/redeclipse_2.0.0_mac.tar.bz2",
      },
      darwin_arm64: {
        name: "redeclipse_2.0.0_mac.tar.bz2",
        executable: "redeclipse.app",
      ...
      linux_amd64: {
        name: "redeclipse-stable-x86_64.AppImage",
        executable: "redeclipse-stable-x86_64.AppImage",
        installSize: "",
        downloadSize: "",
        external_url: "https://github.com/redeclipse/deploy/releases/download/appimage_continuous_stable/redeclipse-stable-x86_64.AppImage",
      },
    },
    project_id: "",
    release_id: "",
