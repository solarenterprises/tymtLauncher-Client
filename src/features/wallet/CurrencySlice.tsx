...
export const refreshCurrencyAsync = createAsyncThunk("currency/refreshCurrency", refreshCurrency);
...
export const currencySlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(refreshCurrencyAsync.fulfilled, (state, action: PayloadAction<any>) => {
